...
first_file_path <- paste0("New_samples/", first_sample, "/sample_filtered_feature_bc_matrix.h5")
...
for (sample_name in other_samples) {
  ...
  file_path <- paste0("New_samples/", sample_name, "/sample_filtered_feature_bc_matrix.h5")
...
```{r}
seurat_object_b@reductions$umap$umap_1
```

```{r}

ggcells(seurat_object_b, mapping=aes(x=umap_1,
                           y=umap_2,
                           colour=sampleID)) +
